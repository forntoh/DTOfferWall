...
object RepoModule {
     ...
     * @param OfferWallNetworkDataSource the implementation of the IMDB network data source
     * @return the implementation of the Movies repository
     */
    @Provides
    fun provideVehiclesRepo(
        OfferWallNetworkDataSource: OfferWallNetworkDataSource,
    ): OfferWallRepo = OfferWallRepoImpl(OfferWallNetworkDataSource)
